...
export default function LockScreen() {
  ...
  return (
    <main className="fade-in" style={{ position: 'absolute', inset: 0, zIndex: 55, background: '#0D0D0C', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 22, padding: '0 40px' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        <h1 style={{ margin: 0, fontSize: 22, fontWeight: 600, letterSpacing: -0.7 }}>Money is locked</h1>
